			...
			if(usuario.length()==0) {
				...
				if(!rset.next()){
					...
					if(usuario.contains("admin")) {
						...
						out.println("<p><a href='inicioAdministrador.jsp' class='btn btn-success'>Pulsa para continuar aquí</a></p>");

					} else {
						out.println("<p>Hola, " + usuario + "!</p>");
						// out.println("<p><a href='pedido.jsp?idUsuario=' class='btn btn-success' >Pulsa para continuar aquí</a></p>");
						out.println("<p><a href='shopping' class='btn btn-success' >Pulsa para continuar aquí</a></p>");
